...
<link href="<?php echo base_url(); ?>assets/css/wishlist.css" rel="stylesheet">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <nav class="list-group">
                ...
                <a class="list-group-item" href="<?php echo base_url(); ?>profile"><i class="fa fa-user"></i>Profile</a>
                ...
                <a class="list-group-item with-badge" href="#"><i class="fa fa-tag"></i>My Tickets<span class="badge badge-primary badge-pill"></span></a>
            </nav>
        </div>
        <div class="col-lg-8">
            ...
            <div class="table-responsive wishlist-table margin-bottom-none">
                <table class="table">
                    <thead>
                        <tr>
                            <th>Product Name</th>
                            <th class="text-center"><a class="btn btn-sm btn-outline-danger" href="<?php echo base_url(); ?>products/clearlist">Clear Wishlist</a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
