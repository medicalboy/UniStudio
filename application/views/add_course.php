...
<head>
    ...
    <link href="assets/css/add_course.css" rel="stylesheet">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="subject" placeholder="subject">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    ...
                                    <input type="file" name="userfilevideo">
                                    
                                    <!-- <label class="label--file" for="file" name="userfile">Choose file</label> -->
                                    <!-- <span class="input-file__info" name="userfile">No file chosen</span> -->
                                </div>
